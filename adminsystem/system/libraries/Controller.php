...
class Controller extends CI_Base {
    ...
    // modified to call base layout

    function load_base_layout($base_layout, $application) {
        $filepath = APPPATH . 'controllers/base/' . $base_layout . '.php';
        if(is_file($filepath)) {
            require_once($filepath);
            $this->base_layout = new $base_layout($application);
        }
    }
}
