...
" class="form-control" size="50" maxlength="255" />                  </div>                  <div class="form-group">                    <label for="user_name_lama">Isi berita                       <i>(English)                      </i> *                     </label>                    <textareastyle name="content_english" cols="72" rows="10"><?php echo $_smarty_tpl->tpl_vars['data']->value['content'];?>
