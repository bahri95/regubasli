<?php /* Smarty version Smarty-3.1.17, created on 2016-10-16 05:55:05
                        ...
                        <div class="col-md-8 bottommargin">
                            ...
                            <div class="col_full bottommargin-lg">
                                <div class="fslider flex-thumb-grid grid-6" data-animation="fade" data-arrows="true" data-thumbs="true">
                                    <div class="flexslider">
                                        <div class="slider-wrap">
                                            <div class="slide" data-thumb="<?php echo $_smarty_tpl->tpl_vars['BASEURL']->value;?>
/doc/foto/1.jpg">
                                                <a href="#">
                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['BASEURL']->value;?>
/doc/foto/foto1.jpg" alt="">
                                                    <div class="overlay">
...
/doc/foto/foto6.jpg" alt="">
                            ...
                            <div class="col_full nobottommargin clearfix">
                                ...
                                <div class="fancy-title title-border">
                                    <h3>|BERIA RELAWAN RAHMAD - SUMUT</h3>
                                </div>

                                <div class="col_one_third">
                                    <div class="ipost clearfix">
                                        <div class="entry-image">
                                            <a href="#"><img class="image_fade" src="<?php echo $_smarty_tpl->tpl_vars['BASEURL']->value;?>
/doc/foto/1.jpg" alt="Image"></a>
                                        </div>
                                            ...
                                            <div class="tab-content clearfix" id="tabs-1">
                                                <div id="popular-post-list-sidebar">
                                                    ...
                                                    <div class="spost clearfix">
                                                        <div class="entry-image">
                                                            <a href="#" class="nobg"><img class="img-circle" src="<?php echo $_smarty_tpl->tpl_vars['BASEURL']->value;?>
/doc/foto/3.jpg" alt=""></a>
                                                        </div>
                                                        <div class="entry-c">
                                                            <div class="entry-title">
